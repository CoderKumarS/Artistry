...
@section('content')
    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900 transition-colors duration-500">
        <div
            class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md transition-transform duration-500 transform hover:scale-105">
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" id="email" name="email" required
                        class="mt-1 block w-full px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                </div>
                <div class="mb-4">
                    <label for="password"
                ...
                <button type="submit"
                    class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-100 dark:focus:ring-offset-gray-900 transition-all duration-300">
                    Login
                </button>
            </form>
            ...
            <p class="mt-4 text-center text-sm text-gray-600 dark:text-gray-400">
                <a href="{{ route('home') }}" class="text-blue-600 dark:text-blue-400 hover:underline">Go back to Home</a>
            </p>
        </div>
    </div>
            ...
            <div
                ...
                <div class="p-6 pt-0">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-4">
                        ...
                        <button type="submit"
                            class="w-full rounded-md bg-black dark:bg-blue-600 text-white py-2 px-4 text-sm font-medium shadow hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                            Sign In
                        </button>
                    </form>
